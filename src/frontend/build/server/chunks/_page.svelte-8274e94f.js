...
<div class="${"text-column svelte-1bccks5"}"><h1 class="${"svelte-1bccks5"}">About BriefCast</h1>
	<p class="${"description svelte-1bccks5"}">BriefCast is an AI-powered short podcast generator from any online resource.
	</p>
	<h2 class="${"svelte-1bccks5"}">How it works</h2>
	<ol><li class="${"svelte-1bccks5"}">Pick a web site: Briefcast works seamlessly with any website that offers RSS/ATOM feeds.
		</li>
		...
		<li class="${"svelte-1bccks5"}">Briefcast automatically updates your podcast. Enjoy!</li></ol>
</div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-8274e94f.js.map
